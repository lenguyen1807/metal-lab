...
struct KernelSpec {
    ...
    void (*encode)(MTL::ComputeCommandEncoder&, const DeviceMatrix&, const DeviceMatrix&,
                   DeviceMatrix&, const GemmShape&, const DispatchPlan&);
};
...
class Kernel {
   public:
    ...
    const char* function() const { return spec_.function; }
    bool supports(const GemmShape& shape) const;
    void encode(MTL::CommandBuffer* command_buffer, const DeviceMatrix& A, const DeviceMatrix& B,
